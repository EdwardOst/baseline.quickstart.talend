...
declare project_users_file="${1:-project_users.data}"
...
do
    ...
    then
        ...
        JSON={"actionName":"createUser","authPass":"admin","authUser":"admin@company.com","userFirstName":"$USER_FNAME","userLastName":"$USER_LNAME","userLogin":"$USER_LOGIN","userPassword":"$USER_PASSWD","userRole":["Administrator"],"userType":"$USER_TYPE"}
        echo "executing ${metaservlet_path} --tac-url \"${tac_url}\" -json-params=\"${JSON}\""
