...
# this factory and other contexts in this directory cannot take arguments
# since that is reserved for the function being called.  These context
# just decorate with current scope wth additional locally scope values
